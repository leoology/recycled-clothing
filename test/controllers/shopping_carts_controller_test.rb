...
class ShoppingCartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_cart" do
    assert_difference('ShoppingCart.count') do
      post shopping_carts_url, params: { shopping_cart: { total: @shopping_cart.total, user_id: @shopping_cart.user_id } }
    end
  ...
  test "should update shopping_cart" do
    patch shopping_cart_url(@shopping_cart), params: { shopping_cart: { total: @shopping_cart.total, user_id: @shopping_cart.user_id } }
